...
contract Token is Ownable {
    ...
    */
        ...
        returns (bool)
    {
        ...
        require(_value <= allowed[_from][msg.sender], "Not authorized to send this amount");
   ...
   * @dev Only the owner, or the sender can burn
   * @param _value The amount of token to be burned.
   */
    function burn(address _who, uint256 _value)
        public
    {
        require(msg.sender == _who || msg.sender == owner(), "Not authorized to burn");
